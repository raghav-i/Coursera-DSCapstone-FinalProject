...
shinyServer(function(input, output) {
  ...
  observe({
    ...
    # Description
    description_text <- "Next Word Prediction is a web application that predicts the next word in a sentence or phrase based on user input. It utilizes N-gram models for accurate word suggestions, assisting users in writing tasks and text completion."
    output$description <- renderText({ description_text })
  })
